...
@keyframes logo-border-keyframes {
  0%   { border-color: bisque; border-width: 20px; }
  50%  { border-color: white;  border-width: 25px; }
  100% { border-color: bisque; border-width: 20px; }
}

.logo-border-animation {
  animation-name: logo-border-keyframes;
  animation-duration: 1s;
  animation-iteration-count: infinite;
}

@keyframes button-keyframes {
  from { margin-left: 20px;  }
  to   { margin-left: 25px; }
}

.button-animation {
  animation-name: button-keyframes;
  animation-duration: 1s;
  animation-iteration-count: infinite;
}

@keyframes answer-keyframes {
  from { transform: rotateX(180deg); backface-visibility: hidden; -webkit-backface-visibility: hidden; }
  to   { transform: rotateX(0deg);   backface-visibility: hidden; -webkit-backface-visibility: hidden; }
}

.answer-animation {
  animation-name: answer-keyframes;
  animation-duration: 1s;
