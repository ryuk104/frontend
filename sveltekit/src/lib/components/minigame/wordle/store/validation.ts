...
import type { GameMode } from '../data-model'
import type { GameDetail } from '../stats'
import { keyboardLayoutNames, ROWS, WORD_LENGTH } from '../data-model'
import { newStats } from '../stats'
import * as game from '../store/game-state'
