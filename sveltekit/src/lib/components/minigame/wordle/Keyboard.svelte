<script lang="ts">
	import { alphabet, keyboardLayoutOptions } from './data-model'
	import { validLetters, swapEnterBackspace, keyboardLayout, openScreen } from './store'
	import { t } from './translations'
	import { moveCarat, submitRow, typeLetter, undoLetter } from './board'
