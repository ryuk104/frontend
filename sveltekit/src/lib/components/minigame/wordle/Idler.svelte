<script lang="ts">
	...
	import type { AnimationPart, MultipartAnimation } from './idle-animations'
	import { AnimationParts } from './idle-animations'
	import type { IdleSchedule } from './idle-scheduler'
	import { getSchedule, startAnimation, stopAnimation } from './idle-scheduler'
